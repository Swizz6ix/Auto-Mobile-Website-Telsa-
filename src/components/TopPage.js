...
function TopPage({fullnth, box3, speedO, topImg, topHeader, subTopHeader, topText1, unit, subText1, topText2, subText2, topText3, subText3, box4, topText4, subText4, brk1, brk2, brk3, mobileImg, clor}) {
  return (
    <div>
    <Wrap>
        <ImageContainer>
